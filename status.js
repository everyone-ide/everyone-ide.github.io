...
p.innerHTML = "The CEO is fixing a on the news page where the RSS feed link text doesn't have the \"lead\" class.";
div.appendChild(p);
...
p3.innerHTML = "Both developers are doing nothing.";
div.appendChild(p3);
